...
/**
 * Reusable middleware that enforces users are logged in with a specific role before running the
 * procedure
...
/**
 * Restricted (authed & role-validated) procedure
 * 
 * If you want a query or mutation to ONLY be accessible to logged in users with
 * a specific role, use this. It verifies the session is valid and guarantees
